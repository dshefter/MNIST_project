"""
Created on Mon Jul  8 15:03:44 2019@author: deenashefter
"""
"""
...
if __name__ == '__main__':
    # ------------------------- set up model --------------------------
    x_ = tf.placeholder(tf.float32, shape=(BATCH_SZ, N_IN), name='x')
    h_, W1_, b1_ = layer(x_, N_IN, N_HID, 'layer1')
